...
# ============ COPY TRADING ============
# Routes moved to /routes/copy_trading_routes.py
from routes.copy_trading_routes import copy_router
...
# Routes moved to /routes/supply_chain_routes.py
from routes.supply_chain_routes import supply_chain_router
app.include_router(supply_chain_router, prefix="/api")


# ============ AI TRADING AGENTS ============
# Routes moved to /routes/agent_routes.py
from routes.agent_routes import agent_router, init_agent_db
...
from routes.risk_routes import risk_router, audit_router, init_risk_db, start_risk_broadcast
